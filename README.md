...
- [ ] v0.1：核心 CLI 流水线 + 基础前端编辑器
- [ ] v0.2：FastAPI 后端 + `/api/rerender-panel` 端点
- [ ] v0.3：多页面编辑器 + 分话导出
- [ ] v0.4：自定义 StylePack 编辑器
- [ ] v1.0：PDF / 条漫格式导出 + 嵌字 Agent

---

## 🤝 参与贡献

欢迎提交 Issue 和 Pull Request！在贡献代码前，请先阅读项目的核心理念——尤其是**结构化状态优先于纯文本**这一原则。
