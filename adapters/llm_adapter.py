...
def _strip_unsupported_schema_fields(schema: dict) -> dict:
    ...
    for key, value in schema.items():
        if key == "additionalProperties":
            ...
            continue  # skip, but remember we saw it
    ...
    # If we removed prefixItems and there's no 'items' field, add a generic one
    if has_prefix_items and "items" not in cleaned and prefix_items_value:
        # Use the first item schema from prefixItems as the generic item schema
